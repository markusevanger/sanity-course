...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[ _type == \"event\" && slug.current == $slug ][0]{ ..., \"date\": coalesce(date, now()), \"doorsOpen\": coalesce(doorsOpen, 0), headline->, venue-> }": EVENT_QUERYResult;
    "*[ _type == \"event\" && defined(slug.current) ]{_id, name, slug, date}|order(date desc)": EVENTS_QUERYResult;
  }
}
